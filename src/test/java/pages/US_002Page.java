...
public class US_002Page {
    ...
    public US_002Page () { PageFactory.initElements(Driver.getDriver(),this); }

    @FindBy (xpath =  "//h2[text()='Have Questions?']")
    public static WebElement haveQuestionsTextElement;

    @FindBy (xpath =  "//span[@class='icon icon-phone']")
    public static WebElement phoneIconElement;

    @FindBy (xpath =  "//span[text()='302 718 2180']")
    public static WebElement phoneNumberElement;

    @FindBy (xpath =  "//span[@class='icon icon-envelope']")
    public static WebElement emailIconElement;

    @FindBy (xpath =  "//span[text()='info@hotelmycamp.com']")
    public static WebElement emailAddressElement;
